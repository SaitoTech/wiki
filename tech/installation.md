...
The following instructions work for most Linux environments. If you are using a Mac you will need [these instructions](tech/linking_installations_mac) on compiling the WASM library and linking it to Saito Javascript under MacOS instead.
