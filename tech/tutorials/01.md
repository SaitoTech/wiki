...
Add these functions to the body of our tutorial file. Your file should look like [like this](https://github.com/SaitoTech/saito-lite-rust/blob/master/mods/tutorial01/tutorial01.js).
